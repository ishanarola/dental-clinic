              ...
              <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                <a className="dropdown-item d-flex align-items-center" href="# ">
                  <div className="dropdown-list-image mr-3">
                    <img className="rounded-circle" src="img/man.png" style={{ maxWidth: 60 }} alt="manImg" />
                ...
                <a className="dropdown-item d-flex align-items-center" href="# ">
                  <div className="dropdown-list-image mr-3">
                    <img className="rounded-circle" src="img/girl.png" style={{ maxWidth: 60 }} alt="girlImg" />
...

        {
          ...
          <Modal
            ...
            footer={() => {
              return (
                <>
                  <button type="button" className="btn btn-outline-primary" onClick={()=>this.toggleModal()}>Cancel</button>
...
export default connect(null, { logout })(withFirebase(Header));